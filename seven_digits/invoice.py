...
pdf = FPDF()
pdf.add_page()
pdf.set_font('Courier', 'IU', 13.0)
pdf.set_xy(105.0, 8.0)
pdf.cell(ln=0, h=22.0, align='C', w=75.0, txt='Lorem Ipsum', border=0)
# pdf.add_page()

pdf.set_font('Courier', '', 13.0)
pdf.set_xy(105.0, 18.0)
pdf.cell(ln=1, h=22.0, align='C', w=75.0, txt='Lorem Ipsum', border=0)

pdf.set_font('Arial', 'I', 13.0)
pdf.set_xy(105.0, 28.0)
pdf.cell(ln=1, h=22.0, align='C', w=75.0, txt='Lorem Ipsum', border=0)

pdf.set_font('Helvetica', '', 13.0)
pdf.set_xy(105.0, 38.0)
pdf.cell(ln=1, h=22.0, align='C', w=75.0, txt='Lorem Ipsum', border=0)

# pdf.add_page()
pdf.set_font('Times', 'I', 13.0)
pdf.set_xy(105.0, 48)
pdf.cell(ln=2, h=22.0, align='C', w=75.0, txt='Lorem Ipsum', border=0)

pdf.set_font('Times', 'IU', 13.0)
pdf.set_xy(105.0, 58)
pdf.cell(ln=2, h=22.0, align='C', w=75.0, txt='Lorem Ipsum', border=0)
...
# pdf.add_font('Pacifico', '', 'Pacifico.ttf', uni=True)
# pdf.set_xy(105.0, 78)
# pdf.cell(ln=2, h=22.0, align='C', w=75.0, txt='Lorem Ipsum', border=0)

# pdf.set_font('Monotype Corsiva', 'I', 13.0)
# pdf.set_xy(95.0, 21.5)
# pdf.cell(ln=2, h=22.0, align='C', w=75.0, txt='Sample Invoice', border=0)
...
pdf.output('./invoice1.pdf', 'F')

import sys
if sys.platform.startswith("linux"):
    os.system("xdg-open ./invoice1.pdf")
else:
    os.system("./invoice1.pdf")